...
describe("Pair Matrix Driver Alignment", () => {
  ...
  it("renders the open popover with compact value rows and driver details", () => {
    ...
    expect(html).toContain('<span class="chart-pair-matrix-counter is-base"');
    expect(html).toContain("<em>Base</em><b>0</b>");
    expect(html).toContain("<em>Quote</em><b>1</b>");
    expect(html).toContain("<em>Outlier</em><b>0</b>");
    ...
    expect(html).toContain('<span class="chart-pair-matrix-counter is-green"');
    expect(html).toContain("<em>Green</em><b>1</b>");
    expect(html).toContain("<em>Red</em><b>0</b>");
