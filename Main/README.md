...
- Macro Signal Lab's separate `FMS-EURUSD-NUMERIC-ROBUST-H4-v11` report splits existing numeric history by S/M agreement, revision reliability, package completeness, Before alignment, score magnitude, and continuation versus rejection. It reuses the flexible exit matrix, is durably cached, and leaves Charts v10 unchanged.
